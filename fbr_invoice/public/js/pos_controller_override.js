        ...
        this.payment = new erpnext.PointOfSale.Payment({
            ...
            events: {
                ...
                submit_invoice: () => {
                    ...
                    this.frm.savesubmit()
                        .then((r) => {
                            this.payment.events.generateFBR();
                ...
                generateFBR: () => {
                    var item_list = []
                    var total_qty = 0
                    var tax_rate = (this.frm.doc.taxes.length > 0 ? this.frm.doc.taxes[0].rate : 0)
                    $.each(this.frm.doc.items, (k, item) => {
                    ...
                    var data = {
                        "InvoiceNumber": "",
                        "POSID": this.settings.pos_id,
                        "USIN": this.frm.doc.name,
                        "DateTime": this.frm.doc.posting_date,
                        "BuyerNTN": this.settings.ntn_no,
                        "BuyerCNIC": null,
                        "BuyerName": this.frm.doc.customer,
                        "BuyerPhoneNumber": null,
                        "TotalBillAmount": this.frm.doc.grand_total,
                        "TotalQuantity": total_qty,
                        "TotalSaleValue": this.frm.doc.net_total,
                        "TotalTaxCharged": this.frm.doc.total_taxes_and_charges,
                        "Discount": "0",
                        "FurtherTax": "0",
                        "PaymentMode": 1,
                        "RefUSIN": null,
                    ...
                    $.ajax('https://gw.fbr.gov.pk/imsp/v1/api/Live/PostData', {
                        ...
                        success: function (data, status, xhr) {
                            ...
                            frappe.call({
                                ...
                                args: {
                                    doctype: cur_pos.frm.doc.doctype,
                                    name: cur_pos.frm.doc.name,
                                    inv: invoiceNumber
                                },
                                async: false,
                                callback: function (e) {
                        ...
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader("Authorization", "Bearer " + cur_pos.settings.fbr_pos_token);
                        },
